...
/*
 * Number of flash wait states according to CPU clock (HCLK) frequency.
 *
 * STM32F405xx/07xx and STM32F415xx/17xx:
 *
 * 2.7V - 3.6V
 *   0 < HCLK <= 30:  0 WS (1 CPU cycle)
 *  30 < HCLK <= 60:  1 WS (2 CPU cycle)
 *  60 < HCLK <= 90:  2 WS (3 CPU cycle)
 *  90 < HCLK <= 120: 3 WS (4 CPU cycle)
 * 120 < HCLK <= 150: 4 WS (5 CPU cycle)
 * 150 < HCLK <= 168: 5 WS (6 CPU cycle)
 *
 * 2.4V - 2.7V
 *   0 < HCLK <= 24:  0 WS (1 CPU cycle)
 *  24 < HCLK <= 48:  1 WS (2 CPU cycle)
 *  48 < HCLK <= 72:  2 WS (3 CPU cycle)
 *  72 < HCLK <= 96:  3 WS (4 CPU cycle)
 *  96 < HCLK <= 120: 4 WS (5 CPU cycle)
 * 120 < HCLK <= 144: 5 WS (6 CPU cycle)
 * 144 < HCLK <= 168: 6 WS (7 CPU cycle)
 *
 * 2.1V - 2.4V
 *   0 < HCLK <= 22:  0 WS (1 CPU cycle)
 *  22 < HCLK <= 44:  1 WS (2 CPU cycle)
 *  44 < HCLK <= 66:  2 WS (3 CPU cycle)
 *  66 < HCLK <= 88:  3 WS (4 CPU cycle)
 *  88 < HCLK <= 110: 4 WS (5 CPU cycle)
 * 110 < HCLK <= 132: 5 WS (6 CPU cycle)
 * 132 < HCLK <= 154: 6 WS (7 CPU cycle)
 * 154 < HCLK <= 168: 7 WS (8 CPU cycle)
 *
 * 1.8V - 2.1V (Prefetch OFF)
 *   0 < HCLK <= 20:  0 WS (1 CPU cycle)
 *  20 < HCLK <= 40:  1 WS (2 CPU cycle)
 *  40 < HCLK <= 60:  2 WS (3 CPU cycle)
 *  60 < HCLK <= 80:  3 WS (4 CPU cycle)
 *  80 < HCLK <= 100: 4 WS (5 CPU cycle)
 * 100 < HCLK <= 120: 5 WS (6 CPU cycle)
 * 120 < HCLK <= 140: 6 WS (7 CPU cycle)
 * 140 < HCLK <= 160: 7 WS (8 CPU cycle)
 */

const struct rcc_clock_scale rcc_hse_config[RCC_CLOCK_END] = {
	{ /* 48MHz */
		.pllm = 8,
		.plln = 96,
		.pllp = 2,
...
void rcc_clock_setup_hse(const struct rcc_clock_scale *clock, uint8_t hse)
{
